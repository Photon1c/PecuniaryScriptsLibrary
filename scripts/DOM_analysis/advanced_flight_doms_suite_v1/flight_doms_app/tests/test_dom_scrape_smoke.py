"""Smoke tests for DOM scraping via :mod:`flight_doms_app`.

These tests are designed to answer a pragmatic question:
...
Behavior
--------
- If the underlying `dom_analyzer.py` implementation cannot be imported,
  the tests will be **skipped** with a clear reason.
...
.. code-block:: bash
    ...
    pytest -q flight_doms_app/tests/test_dom_scrape_smoke.py
...
from flight_doms_app.adapter_dom import (
    DepthSnapshotResult,
